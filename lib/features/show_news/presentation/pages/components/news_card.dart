...
class NewsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => NewsViewPage(newsInfo: newsInfo))),
    child: Container(
          ...
          child: Stack(
            children: [
              Container(
                ...
                child: newsInfo.imageURL != null ? Image.network(newsInfo.imageURL!, fit: BoxFit.cover): const SizedBox(),
              ),
              Positioned(
                left: 16,
                right: 16,
